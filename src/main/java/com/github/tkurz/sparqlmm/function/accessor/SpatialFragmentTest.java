 ...
 */
@FunctionDoc(title = "SpatialFragment Test", properties = {SpatialEntity.class}, reference = FunctionDoc.Reference.spatial, description = "returns true is value is a spatial fragment.", type = FunctionDoc.Type.accessorFunction)
public class SpatialFragmentTest implements Function {
    @Override
    public String getURI() {
        return Constants.NAMESPACE + "isSpatialFragment";
    }
