 ...
 */
@FunctionDoc(title = "TemporalFragment Test", properties = {TemporalEntity.class}, reference = FunctionDoc.Reference.temporal, description = "returns true is value is a temporal fragment.", type = FunctionDoc.Type.accessorFunction)
public class TemporalFragmentTest implements Function {
    @Override
    public String getURI() {
        return Constants.NAMESPACE + "isTemporalFragment";
    }
