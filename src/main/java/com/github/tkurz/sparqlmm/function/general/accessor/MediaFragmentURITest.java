...
public class MediaFragmentURITest implements Function {
    ...
    public String getURI() {
        return Constants.NAMESPACE + "isMediaFragmentURI";
    }
    ...
    public Value evaluate(ValueFactory valueFactory, Value... values) throws ValueExprEvaluationException {
        ...
        try {
            return FunctionHelper.isMediaFragmentURI(values[0]) ? FunctionHelper.BOOL_LITERAL_TRUE : FunctionHelper.BOOL_LITERAL_FALSE;
