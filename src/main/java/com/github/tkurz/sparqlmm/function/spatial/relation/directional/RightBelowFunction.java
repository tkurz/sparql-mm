 ...
 */
@FunctionDoc(title = "rightBelow", properties = {SpatialEntity.class, SpatialEntity.class}, reference = FunctionDoc.Reference.spatial, description = "returns true p1 if is right below p2 (based on model m), else false.")
public class RightBelowFunction implements Function {

    /**
     * return the URI
     */
    public String getURI() {
        return Constants.NAMESPACE + "rightBelow";
    }
    ...
    public Value evaluate(ValueFactory valueFactory, Value... values) throws ValueExprEvaluationException {
        try {
            ...
            //evaluate
            return valueFactory.createLiteral(SpatialFunction.DirectionalFunction.rightBelow(entities[0], entities[1]));
