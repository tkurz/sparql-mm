 ...
 */
@FunctionDoc(title = "rightBeside", properties = {SpatialEntity.class, SpatialEntity.class}, reference = FunctionDoc.Reference.spatial, description = "returns true p1 if is right beside p2 (based on model m), else false.")
public class RightBesideFunction implements Function {
    ...
    public Value evaluate(ValueFactory valueFactory, Value... values) throws ValueExprEvaluationException {
        try {
            ...
            //evaluate
            return valueFactory.createLiteral(SpatialFunction.DirectionalFunction.rightBeside(entities[0], entities[1]));
