 ...
 */
@FunctionDoc(title = "crosses", properties = {SpatialEntity.class, SpatialEntity.class}, reference = FunctionDoc.Reference.spatial, description = "returns true if p1.shape and p2.shape have common points and p1.shape.edge and p2.shape.edge has common points, else false.")
public class CrossesFunction implements Function {
    ...
    public Value evaluate(ValueFactory valueFactory, Value... values) throws ValueExprEvaluationException {
        try {
            ...
            //evaluate
            return valueFactory.createLiteral(SpatialFunction.TopologicalFunction.crosses(entities[0], entities[1]));
