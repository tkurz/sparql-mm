 ...
 */
@FunctionDoc(title = "spatialDisjoint", properties = {SpatialEntity.class, SpatialEntity.class}, reference = FunctionDoc.Reference.spatial, description = "returns true is p1.shape has no common points with p2.shape, else false.")
public class DisjointFunction implements Function {
    ...
    public Value evaluate(ValueFactory valueFactory, Value... values) throws ValueExprEvaluationException {
        try {
            ...
            //evaluate
            return valueFactory.createLiteral(SpatialFunction.TopologicalFunction.disjoint(entities[0], entities[1]));
