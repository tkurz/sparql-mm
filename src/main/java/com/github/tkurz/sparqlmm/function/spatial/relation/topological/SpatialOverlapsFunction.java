 ...
 */
@FunctionDoc(title = "spatialOverlaps", properties = {SpatialEntity.class, SpatialEntity.class}, reference = FunctionDoc.Reference.spatial, description = "returns true if p1.shape and p2.shape have common points, else false.")
public class SpatialOverlapsFunction implements Function {
