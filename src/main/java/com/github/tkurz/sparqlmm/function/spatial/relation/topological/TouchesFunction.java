 ...
 */
@FunctionDoc(title = "spatialTouches", properties = {SpatialEntity.class, SpatialEntity.class}, reference = FunctionDoc.Reference.spatial, description = "returns true if p1.shape.edge has at least one common point with p2.shape.edge and p1.shape.interior has no common point with p2.shape.interior, else false.")
public class TouchesFunction implements Function {
    ...
    public String getURI() {
        return Constants.NAMESPACE + "touches";
    }
    ...
    public Value evaluate(ValueFactory valueFactory, Value... values) throws ValueExprEvaluationException {
        try {
            ...
            //evaluate
            return valueFactory.createLiteral(SpatialFunction.TopologicalFunction.touches(entities[0], entities[1]));
