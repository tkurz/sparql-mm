 ...
 */
@FunctionDoc(title = "during", properties = {TemporalEntity.class, TemporalEntity.class}, reference = FunctionDoc.Reference.temporal, description = "inverse function of contains.")
public class DuringFunction implements Function {

    /**
     * return the URI
     */
    public String getURI() {
        return Constants.NAMESPACE + "during";
    }
    ...
    public Value evaluate(ValueFactory valueFactory, Value... values) throws ValueExprEvaluationException {
        try {
            ...
            //evaluate
            return valueFactory.createLiteral(TemporalFunction.during(entities[0], entities[1]));
