 ...
 */
@FunctionDoc(title = "finishes", properties = {TemporalEntity.class, TemporalEntity.class}, reference = FunctionDoc.Reference.temporal, description = "is the inverse function of finishes.")
public class FinishedByFunction implements Function {

    /**
     * return the URI
     */
    public String getURI() {
        return Constants.NAMESPACE + "finishedBy";
    }
    ...
    public Value evaluate(ValueFactory valueFactory, Value... values) throws ValueExprEvaluationException {
        try {
            ...
            //evaluate
            return valueFactory.createLiteral(TemporalFunction.finishedBy(entities[0], entities[1]));
