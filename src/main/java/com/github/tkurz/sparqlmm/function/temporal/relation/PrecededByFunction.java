 ...
 */
@FunctionDoc(title = "after", properties = {TemporalEntity.class, TemporalEntity.class}, reference = FunctionDoc.Reference.temporal, description = "returns *true* if resource1.start >= resource2.end, else *false*.")
public class PrecededByFunction implements Function {
    ...
    public Value evaluate(ValueFactory valueFactory, Value... values) throws ValueExprEvaluationException {
        try {
            ...
            //evaluate
            return valueFactory.createLiteral(TemporalFunction.precededBy(entities[0],entities[1]));
