 ...
 */
@FunctionDoc(title = "Precedes", properties = {TemporalEntity.class, TemporalEntity.class}, reference = FunctionDoc.Reference.temporal, description = "returns true if p1.end < p2.start, else false.")
public class PrecedesFunction implements Function {

    /**
     * return the URI
     */
    public String getURI() {
        return Constants.NAMESPACE + "precedes";
    }
    ...
    public Value evaluate(ValueFactory valueFactory, Value... values) throws ValueExprEvaluationException {
        try {
            ...
            //evaluate
            return valueFactory.createLiteral(TemporalFunction.precedes(entities[0], entities[1]));
