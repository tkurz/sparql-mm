 ...
 */
@FunctionDoc(title = "starts", properties = {TemporalEntity.class, TemporalEntity.class}, reference = FunctionDoc.Reference.temporal, description = "returns true if p1.start == p2.start and p1.end < p2.end , else false.")
public class StartsFunction implements Function {
    ...
    public Value evaluate(ValueFactory valueFactory, Value... values) throws ValueExprEvaluationException {
        try {
            ...
            //evaluate
            return valueFactory.createLiteral(TemporalFunction.starts(entities[0], entities[1]));
