 ...
 */
@FunctionDoc(title = "bottom", reference = FunctionDoc.Reference.spatial, description = "returns true if resource.y >= 50%.")
public class BottomFunction implements Function {
    ...
    public String getURI() {
        return Constants.NAMESPACE + "bottom";
    }
    ...
    public Value evaluate(ValueFactory valueFactory, Value... values) throws ValueExprEvaluationException {
        try {
            ...
            return valueFactory.createLiteral(uris[0].getMediaFragment().getSpatialFragment().bottom());
