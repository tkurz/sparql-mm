 ...
 */
@FunctionDoc(title = "leftBeside", reference = FunctionDoc.Reference.spatial, description = "returns true if resource1.x + resource1.w <= resource2.x, else false.")
    ...
    public Value evaluate(ValueFactory valueFactory, Value... values) throws ValueExprEvaluationException {
        try {
            ...
            return valueFactory.createLiteral(
                    uris[0].getMediaFragment().getSpatialFragment().leftBeside(uris[1].getMediaFragment().getSpatialFragment()));
