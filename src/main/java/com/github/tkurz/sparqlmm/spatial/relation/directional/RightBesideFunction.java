 ...
 */
@FunctionDoc(title = "rightBeside", reference = FunctionDoc.Reference.spatial, description = "returns true if resource2.x + resource2.w <= resource1.x, else false.")
    ...
    public Value evaluate(ValueFactory valueFactory, Value... values) throws ValueExprEvaluationException {
        try {
            ...
            return valueFactory.createLiteral(
                    uris[0].getMediaFragment().getSpatialFragment().rightBeside(uris[1].getMediaFragment().getSpatialFragment()));
