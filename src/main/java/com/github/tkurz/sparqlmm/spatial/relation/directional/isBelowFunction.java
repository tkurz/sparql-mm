 ...
 */
@FunctionDoc(title = "isBelow", reference = FunctionDoc.Reference.spatial, description = "returns true if resource2.y + resource2.h <= resource1.y, else false.")
public class IsBelowFunction implements Function {

    /**
     * return the URI
     */
    public String getURI() {
        return Constants.NAMESPACE + "isBelow";
    }
    ...
    public Value evaluate(ValueFactory valueFactory, Value... values) throws ValueExprEvaluationException {
        try {
            ...
            return valueFactory.createLiteral(
                    uris[0].getMediaFragment().getSpatialFragment().isBelow(uris[1].getMediaFragment().getSpatialFragment()));
